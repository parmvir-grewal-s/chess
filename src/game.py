...
class Game:
    ...
    # Here we will write our 'show' methods
        ...
        for row in range(ROWS):
            for col in range(COLS):
                ...
                if row == 7:
                    ...
                    # label
                    label = self.config.font.render(Square.get_label_col(col), 1, colour)
        ...
        for row in range(ROWS):
            for col in range(COLS):
                ...
                if self.board.squares[row][col].has_piece():
                    ...
                    # show all pieces EXCEPT dragged piece
    ...
    def show_moves(self, surface):
        ...
        if self.dragger.dragging:
            ...
            for move in piece.moves:
                #square colour
                highlighted_colour = theme.moves.light if (move.final.row + move.final.col) % 2 == 0 else theme.moves.dark
                # rect
                rect = (move.final.col * SQSIZE, move.final.row * SQSIZE, SQSIZE, SQSIZE)
                # blit
                pygame.draw.rect(surface, highlighted_colour, rect)
    ...
    def show_hover(self, surface):
        if self.hovered_square:
            ...
            # blit
            pygame.draw.rect(surface, colour, rect, width=4)
